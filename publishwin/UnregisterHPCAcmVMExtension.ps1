...
{
    $uri = "https://management.core.chinacloudapi.cn/5a08dd6d-4a18-4f07-bebb-aeaf6167e4d8/services/extensions/Microsoft.HpcPack/HpcAcmAgentWin/$Version"
}
else
{
    $uri = "https://management.core.windows.net/630763e2-8d65-4e0e-b2be-328808b2f120/services/extensions/Microsoft.HpcPack/HpcAcmAgentWin/$Version"
}
$uri
